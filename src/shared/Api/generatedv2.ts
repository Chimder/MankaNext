...
export interface HandlerEmpty { [key: string]: unknown }
...
export const deleteUserCookie = (
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      return customInstance<HandlerEmpty[]>(
      {url: `/user/cookie/delete`, method: 'GET'
    },
      options);
    }
...
export type DeleteUserCookieResult = NonNullable<Awaited<ReturnType<typeof deleteUserCookie>>>
...
export type GetUserSessionResult = NonNullable<Awaited<ReturnType<typeof getUserSession>>>
